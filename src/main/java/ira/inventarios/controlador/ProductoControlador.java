package ira.inventarios.controlador;

import ira.inventarios.exception.RecursoNoEncontradoExcepcion;
import ira.inventarios.modelo.Producto;
import ira.inventarios.servicio.ProductoServicio;
...
public class ProductoControlador {
    ...
    public ResponseEntity<Producto> obtenerProductoPorId(
        ...
        if (producto!=null) {
           ...
           throw new RecursoNoEncontradoExcepcion("No se encontro el id especificado" + id);
        }
    }
